function [inpaintedImg,origImg,fillImg,C,D,fillMovie] = inpaintc(imgFilename,fillFilename,fillColor)
%INPAINT  Exemplar-based inpainting.
%
% Usage:   [inpaintedImg,origImg,fillImg,C,D,fillMovie] ...
%                = inpaintc(imgFilename,fillFilename,fillColor)
% Inputs: 
%   imgFilename    Filename of the original image.  (imreaded)
%   fillFilename   Filename of the image specifying the fill region. (imreaded)
